  ...
  return (
    <div className="flex flex-col items-center mb-19">
      ...
      <div className="flex flex-col lg:flex-row flex-wrap justify-center">
        <div className="flex flex-col justify-evenly items-center bg-gray-card mx-11 text-center w-[21.5rem] h-[26.8125rem] lg:mt-15">
        ...
        <div className="flex flex-col justify-evenly items-center bg-gray-card mx-11 text-center w-[21.5rem] h-[26.8125rem] mt-15">
          ...
          <Texto type="desc-card">
            Entenda como manter a credibilidade e autoridade da sua empresa
            sendo transparente na coleta e proteção de dados pessoais dos seus
      ...
      <Button variant="baixarAgora" className=" w-[379px] h-[52px] font-graphik-bold">
        Baixe agora!
      </Button>
    </div>
  );
